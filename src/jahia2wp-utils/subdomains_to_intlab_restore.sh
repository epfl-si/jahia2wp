...
then
	#Restauration des fichiers dans le rÃpertoire du site
	...
	#DÃ©placer les fichiers dans le bon rÃpertoire
	...
	#Restauration de la base de donnÃes
	...
	#DÃ©sintallations des plugins 2010
