...
function epfl_scripts() {
	...
	wp_enqueue_script( 'epfl-scripts', get_template_directory_uri() . '/assets/js/main.js', array( 'jquery' ), null , true );
	
	wp_localize_script( 'epfl-scripts', 'epfl_l10n', array(
  	'expand' => __( 'Expand child menu', 'epfl' ),
  	'collapse' => __( 'Collapse child menu', 'epfl' ),
  ) );
