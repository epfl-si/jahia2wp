...
function getFilteredCourses($semesters = null,$polyperspectives = null,$keywords = null,$teachers = null,$languages = null){
    ...
    $sql .= " ORDER BY semester_code, code";
	...
	foreach($courses as $course) {
        ...
        if($course->exam_info == 'semester'){
			$examSemesterImgPath = plugin_dir_url(__DIR__)."/images/".$coursePeriod."24_icon.png";
			$examInfo = __('During the semester', 'epfl-courses-se');
        }
        ...
        $html = $html. "<tbody>
                        ...
                        <tr>
                            ...
                            <td style='text-align:center'><img src='".$examSemesterImgPath."' style='margin-right:5px;;width:16px;height:16px;'>" . $examInfo . "</td>
