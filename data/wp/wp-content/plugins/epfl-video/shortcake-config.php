        ...
        shortcode_ui_register_for_shortcode(
            ...
            array(
                ...
                'attrs'         => array(
                        ...
                        array(
                            'label'         => '<h3>' . esc_html__('Video width', 'epfl-video') . '</h3>',
                            'attr'          => 'width',
                            'type'          => 'text',
                            'value'         => '600',
                            'description'   => esc_html__('Recommended value: 600', 'epfl-video'),
                        ),
                        array(
                            'label'         => '<h3>' . esc_html__('Video height', 'epfl-video') . '</h3>',
                            'attr'          => 'height',
                            'type'          => 'text',
                            'value'         => '400',
                            'description'   => esc_html__('Recommended value: 400', 'epfl-video'),
                        ),
                 ),
