...
Class ShortCakeMementoConfig
{
    ...
    {
        return array (
            array('value' => '1', 'label' => esc_html__('Template slider wrapper with the first highlighted event', 'epfl')),
            array('value' => '2', 'label' => esc_html__('Template slider wrapper without the first highlighted event', 'epfl')),
